function checkPassword_2() {
  ...
  // 실제로 공유받은 주소: https://docs.google.com/spreadsheets/d/1qL1RjRAAdmLONrdEioM4UbHFVWiYUlaKGy4JRcEEvXk/edit?usp=sharing 여기에서,
  // /edit?usp=sharing 부분을 /htmlview 로 바꾸면 됩니다.
  window.open(
    'https://docs.google.com/spreadsheets/d/1qL1RjRAAdmLONrdEioM4UbHFVWiYUlaKGy4JRcEEvXk/htmlview',
    '_blank'
  );
